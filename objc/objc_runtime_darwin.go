...
// For a super call, class must be the class defining the executing method.
func (id ID) SendSuper2(class Class, sel SEL, args ...any) ID {
	super := &objc_super{
		receiver:   id,
		superClass: class,
	}
...
// For a super call, class must be the class defining the executing method.
func SendSuper2[T any](id ID, class Class, sel SEL, args ...any) T {
	super := &objc_super{
		receiver:   id,
		superClass: class,
	}
