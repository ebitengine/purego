...
func init() {
	...
	purego.RegisterFuncHandle(objc, "objc_msgSend", &objc_msgSend)
	purego.RegisterFuncHandle(objc, "objc_msgSendSuper2", &objc_msgSendSuper2)
	purego.RegisterFuncHandle(objc, "object_getClass", &object_getClass)
	purego.RegisterFuncHandle(objc, "objc_getClass", &objc_getClass)
	purego.RegisterFuncHandle(objc, "objc_getProtocol", &objc_getProtocol)
	purego.RegisterFuncHandle(objc, "objc_allocateClassPair", &objc_allocateClassPair)
	purego.RegisterFuncHandle(objc, "objc_registerClassPair", &objc_registerClassPair)
	purego.RegisterFuncHandle(objc, "sel_registerName", &sel_registerName)
	purego.RegisterFuncHandle(objc, "class_getSuperclass", &class_getSuperclass)
	purego.RegisterFuncHandle(objc, "class_getInstanceVariable", &class_getInstanceVariable)
	purego.RegisterFuncHandle(objc, "class_addMethod", &class_addMethod)
	purego.RegisterFuncHandle(objc, "class_addIvar", &class_addIvar)
	purego.RegisterFuncHandle(objc, "class_addProtocol", &class_addProtocol)
	purego.RegisterFuncHandle(objc, "ivar_getOffset", &ivar_getOffset)
}
