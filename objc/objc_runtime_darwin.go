...
func init() {
	...
	purego.FuncHandle(objc, "objc_msgSend", &objc_msgSend)
	purego.FuncHandle(objc, "objc_msgSendSuper2", &objc_msgSendSuper2)
	purego.FuncHandle(objc, "object_getClass", &object_getClass)
	purego.FuncHandle(objc, "objc_getClass", &objc_getClass)
	purego.FuncHandle(objc, "objc_getProtocol", &objc_getProtocol)
	purego.FuncHandle(objc, "objc_allocateClassPair", &objc_allocateClassPair)
	purego.FuncHandle(objc, "objc_registerClassPair", &objc_registerClassPair)
	purego.FuncHandle(objc, "sel_registerName", &sel_registerName)
	purego.FuncHandle(objc, "class_getSuperclass", &class_getSuperclass)
	purego.FuncHandle(objc, "class_getInstanceVariable", &class_getInstanceVariable)
	purego.FuncHandle(objc, "class_addMethod", &class_addMethod)
	purego.FuncHandle(objc, "class_addIvar", &class_addIvar)
	purego.FuncHandle(objc, "class_addProtocol", &class_addProtocol)
	purego.FuncHandle(objc, "ivar_getOffset", &ivar_getOffset)
}
