...
const templateSymbols = `// THIS FILE IS GENERATED BY 'go generate' with gen.go. DO NOT EDIT!!!
// SPDX-License-Identifier: Apache-2.0
// SPDX-FileCopyrightText: 2022 The Ebitengine Authors
...
const templateTrampolinesStubs = `// THIS FILE IS GENERATED BY 'go generate' with gen.go. DO NOT EDIT!!!
// SPDX-License-Identifier: Apache-2.0
// SPDX-FileCopyrightText: 2022 The Ebitengine Authors
